	...
	<body class="goto-here">
		...
		<hr>
			...
			<div class="tab-content">
               <?php foreach ($cats as $key1 => $cat1) { 
               	   $cat_id = $cat1['id'];
               	   $catofpro = mysqli_query($conn,"SELECT * FROM product WHERE status = 1 AND category_id = $cat_id order by id DESC LIMIT 4");
               	?>
				<div role="tabpanel" class="tab-pane <?php echo $key1 ==0? 'active' : ''  ?>" id="tab<?php echo $cat1['id'] ?>">
							<div class="container">
								<div class="row">
									<?php foreach ($catofpro as $top) { ?>
										<div href="#" class="col-md-6 col-lg-3 ftco-animate">
											<div class="product">
												<a href="#" class="img-prod"><img class="img-fluid" src="public/uploads/<?php echo $top['image'] ?>" alt="Colorlib Template">
													<div class="overlay"></div>
												</a>
												<div class="text py-3 pb-4 px-3 text-center">
													...
													<div class="bottom-area d-flex px-3">
														<div class="m-auto d-flex">
															<a href="#modal-id" data-toggle="modal" class="add-to-cart d-flex justify-content-center align-items-center text-center" >
			...
			<div class="container">
				<div class="row">
					<?php foreach ($topproduct as $top) { ?>
						<div href="#modal-id" data-toggle="modal" class="col-md-6 col-lg-3 ftco-animate">
							<div class="product">
								<a href="#" class="img-prod"><img class="img-fluid" src="public/uploads/<?php echo $top['image'] ?>" alt="Colorlib Template">
									<div class="overlay"></div>
								</a>
		...
		<a class="btn btn-primary" data-toggle="modal" href='#modal-id'>Chi tiết sản phẩm</a>
			...
			<div class="modal-dialog" style="width: 90%">
				<div class="modal-content">
					...
					<div class="modal-body" style="width: 100%">
						<iframe src="" style="width: 100%; height: 500px; border: none; overflow-y: autu">
