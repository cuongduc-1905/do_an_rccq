	...
	<body class="goto-here">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown04">
								<?php foreach ($categoryi as $dm) {?>
									<a class="dropdown-item" href="all-product.php"><?php echo $dm['name'] ?></a>
								<?php } ?>
							</div>
						</li>
			...
			<div class="container">
				<div class="row justify-content-center mb-3 pb-3">
					<div class="col-md-12 heading-section text-center ftco-animate">
						...
						<h2 class="mb-4"><a href="http://localhost/do_an_rcq/all-product.php">all category</a></h2>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
					</div>
				</div>   		
			</div>
			<div class="container">
				<?php $category = mysqli_query($conn,'SELECT * FROM category WHERE status = 1 ORDER BY id DESC LIMIT 4') ?>
				<div class="row">
					<?php foreach ($category as $dm) {?>
						<div class="col-md-6">
							<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(public/images/<?php echo $dm['image'] ?>);">
								<div class="text px-3 py-1">
									<h2 class="mb-0"><a href="http://localhost/do_an_rcq/all-product.php"><?php echo $dm['name'] ?></a></h2>
								</div>		
							</div>
						</div>
				    <?php } ?>
		...
		<section class="ftco-section">
			...
			<?php $topproduct = mysqli_query($conn, "SELECT * FROM product WHERE status =1 ORDER BY id DESC LIMIT 8");?>
			<div class="container">
				<div class="row">
								...
								<div class="text py-3 pb-4 px-3 text-center">
									...
									<div class="bottom-area d-flex px-3">
										<div class="m-auto d-flex">
											<a ng-click="" href="product-detail.php?id=<?php echo $top['id'] ?>" class="add-to-cart d-flex justify-content-center align-items-center text-center" >
												<span><i class="ion-ios-menu"></i></span>
											</a>
											<a href="cart.php?id=<?php echo $top['id'] ?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
